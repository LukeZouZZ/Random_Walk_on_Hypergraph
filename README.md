...
Performance comparison on the Platinum dataset (4,548 molecules):

| Method | Time to find top-1 | Similarity achieved | Molecules evaluated |
|--------|-------------------|---------------------|---------------------|
| Exhaustive search | 2.3s | 0.93 (optimal) | 4,548 |
| Original RW | 0.8s | 0.93 | ~150 |
| **Hypergraph-MCMC** | **0.08s** | **0.93** | **~120** |

## References

1. Zhou, D., Huang, J., & Schölkopf, B. (2006). Learning with hypergraphs: Clustering, classification, and embedding. NeurIPS.
2. Chitra, U., & Raphael, B. (2019). Random walks on hypergraphs with edge-dependent vertex weights. ICML.
3. Rogers, D., & Hahn, M. (2010). Extended-connectivity fingerprints. Journal of Chemical Information and Modeling.
